...
public class JwtUtility {
    ...
    public String generateToken(Client client) {
        String subject = getSubjectFromUser(client);
    ...
    public Boolean validateToken(String token, Client client) {
        ...
        return (subject.equals(getSubjectFromUser(client)) && !isTokenExpired(token));
    }
    ...
    private String getSubjectFromUser(Client client) {
